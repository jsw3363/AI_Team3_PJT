...
auc_writer = open_writer("5auc_adasyn_result_on_rf.csv")
balance_writer = open_writer("5balance_adasyn_result_on_rf.csv")
recall_writer = open_writer("5recall_adasyn_result_on_rf.csv")
pf_writer = open_writer("5pf_adasyn_result_on_rf.csv")
brier_writer = open_writer("5brier_adasyn_result_on_rf.csv")
mcc_writer = open_writer("5mcc_adasyn_result_on_rf.csv")

stable_auc_writer = open_writer("5auc_stable_adasyn_result_on_rf.csv")
stable_balance_writer = open_writer("5balance_stable_adasyn_result_on_rf.csv")
stable_recall_writer = open_writer("5recall_stable_adasyn_result_on_rf.csv")
stable_pf_writer = open_writer("5pf_stable_adasyn_result_on_rf.csv")
stable_brier_writer = open_writer("5brier_stable_adasyn_result_on_rf.csv")
stable_mcc_writer = open_writer("5mcc_stable_adasyn_result_on_rf.csv")
